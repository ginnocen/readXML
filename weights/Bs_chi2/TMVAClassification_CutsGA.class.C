...
abs(tktkmass-1.019455)        abs_tktkmass_M_1.019455_      abs(tktkmass-1.019455)        abs(tktkmass-1.019455)                                          'F'    [9.97619622467e-07,0.0999601632357]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmax[0] = 0.999958574771881;
      fVmin[1] = 0.0105074793100357;
      fVmax[1] = 235.647094726562;
      fVmin[2] = -1;
      fVmax[2] = 1;
      fVmin[3] = 0.000159545757924207;
      fVmax[3] = 57.112678527832;
      fVmin[4] = 3.46463129972108e-05;
      fVmax[4] = 77.7723770141602;
      fVmin[5] = 9.97619622467028e-07;
      fVmax[5] = 0.0999601632356644;
