...
NVar 4
chi2cl                        chi2cl                        chi2cl                        chi2cl                                                          'F'    [0.010013287887,0.99998408556]
(d0/d0Err)                    _d0_D_d0Err_                  (d0/d0Err)                    (d0/d0Err)                                                      'F'    [0.0146549819037,262.774841309]
cos(dtheta)                   cos_dtheta_                   cos(dtheta)                   cos(dtheta)                                                     'F'    [-1,1]
abs(tktkmass-0.89594)         abs_tktkmass_M_0.89594_       abs(tktkmass-0.89594)         abs(tktkmass-0.89594)                                           'F'    [3.56377968274e-05,0.399520099163]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmax[0] = 0.999984085559845;
      fVmin[1] = 0.0146549819037318;
      fVmax[1] = 262.774841308594;
      fVmin[2] = -1;
      fVmax[2] = 1;
      fVmin[3] = 3.56377968273591e-05;
      fVmax[3] = 0.399520099163055;
