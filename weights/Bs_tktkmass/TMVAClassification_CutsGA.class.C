...
NVar 6
chi2cl                        chi2cl                        chi2cl                        chi2cl                                                          'F'    [0.0100275436416,0.99995559454]
d0/d0Err                      d0_D_d0Err                    d0/d0Err                      d0/d0Err                                                        'F'    [0.0178942773491,235.647094727]
cos(dtheta)                   cos_dtheta_                   cos(dtheta)                   cos(dtheta)                                                     'F'    [-1,1]
abs(trk1Dxy/trk1D0Err)        abs_trk1Dxy_D_trk1D0Err_      abs(trk1Dxy/trk1D0Err)        abs(trk1Dxy/trk1D0Err)                                          'F'    [4.0910566895e-05,73.0949401855]
abs(trk2Dxy/trk2D0Err)        abs_trk2Dxy_D_trk2D0Err_      abs(trk2Dxy/trk2D0Err)        abs(trk2Dxy/trk2D0Err)                                          'F'    [2.10514444916e-05,77.7723770142]
abs(tktkmass-1.019455)        abs_tktkmass_M_1.019455_      abs(tktkmass-1.019455)        abs(tktkmass-1.019455)                                          'F'    [1.83208464932e-06,0.0999466925859]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmax[0] = 0.999955594539642;
      fVmin[1] = 0.0178942773491144;
      fVmax[1] = 235.647094726562;
      fVmin[2] = -1;
      fVmax[2] = 1;
      fVmin[3] = 4.0910566895036e-05;
      fVmax[3] = 73.0949401855469;
      fVmin[4] = 2.10514444916043e-05;
      fVmax[4] = 77.7723770141602;
      fVmin[5] = 1.8320846493225e-06;
      fVmax[5] = 0.0999466925859451;
