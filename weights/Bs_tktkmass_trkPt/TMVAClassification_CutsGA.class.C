...
NVar 4
chi2cl                        chi2cl                        chi2cl                        chi2cl                                                          'F'    [0.0100845936686,0.999820351601]
(d0/d0Err)                    _d0_D_d0Err_                  (d0/d0Err)                    (d0/d0Err)                                                      'F'    [0.0178942773491,235.647094727]
cos(dtheta)                   cos_dtheta_                   cos(dtheta)                   cos(dtheta)                                                     'F'    [-0.999999940395,1]
abs(tktkmass-1.019455)        abs_tktkmass_M_1.019455_      abs(tktkmass-1.019455)        abs(tktkmass-1.019455)                                          'F'    [7.90519720795e-07,0.0998385697603]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmin[0] = 0.0100845936685801;
      fVmax[0] = 0.999820351600647;
