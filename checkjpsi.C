  ...
  */
  ...
  for (Long64_t i=0; i<nentries;i++) {
    ...
    */
    ...
    for (int j=0;j<BInfo_uj_size;j++) 
      {
	
	mu1px = MuonInfo_pt[BInfo_uj_rfmu1_index[j]]*cos(MuonInfo_phi[BInfo_uj_rfmu1_index[j]]);
	mu1py = MuonInfo_pt[BInfo_uj_rfmu1_index[j]]*sin(MuonInfo_phi[BInfo_uj_rfmu1_index[j]]);
	mu1pz = MuonInfo_pt[BInfo_uj_rfmu1_index[j]]*sinh(MuonInfo_eta[BInfo_uj_rfmu1_index[j]]);
	b4P->SetXYZM(mu1px,mu1py,mu1pz,MUON_MASS);
	mu1E = b4P->E();

	mu2px = MuonInfo_pt[BInfo_uj_rfmu2_index[j]]*cos(MuonInfo_phi[BInfo_uj_rfmu2_index[j]]);
	mu2py = MuonInfo_pt[BInfo_uj_rfmu2_index[j]]*sin(MuonInfo_phi[BInfo_uj_rfmu2_index[j]]);
	mu2pz = MuonInfo_pt[BInfo_uj_rfmu2_index[j]]*sinh(MuonInfo_eta[BInfo_uj_rfmu2_index[j]]);
