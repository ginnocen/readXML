...
void loopCutBs()
{
  ...
  TFile* inputS = new TFile("/mnt/hadoop/cms/store/user/jwang/nt_BoostedMC_20140418_Phi_TriggerMatchingMuon_CandBase_skim.root");
  ...
  if(selection=="Bs")
    {
      ...
      opt_cut = "chi2cl>3.8738149038918666e-02&&(d0/d0Err)>4.3757767373592902e+00&&cos(dtheta)>-7.8046623787916514e-01&&abs(trk1Dxy/trk1D0Err)>3.6438129126563079e-03&&abs(trk2Dxy/trk2D0Err)>2.1125706915688469e-01&&abs(tktkmass-1.019455)<1.6205386316897691e-02";
      opt_cut1 = "(d0/d0Err)>4.3757767373592902e+00&&cos(dtheta)>-7.8046623787916514e-01&&abs(trk1Dxy/trk1D0Err)>3.6438129126563079e-03&&abs(trk2Dxy/trk2D0Err)>2.1125706915688469e-01&&abs(tktkmass-1.019455)<1.6205386316897691e-02";
      opt_cut2 = "chi2cl>3.8738149038918666e-02&&cos(dtheta)>-7.8046623787916514e-01&&abs(trk1Dxy/trk1D0Err)>3.6438129126563079e-03&&abs(trk2Dxy/trk2D0Err)>2.1125706915688469e-01&&abs(tktkmass-1.019455)<1.6205386316897691e-02";
      opt_cut3 = "chi2cl>3.8738149038918666e-02&&(d0/d0Err)>4.3757767373592902e+00&&abs(trk1Dxy/trk1D0Err)>3.6438129126563079e-03&&abs(trk2Dxy/trk2D0Err)>2.1125706915688469e-01&&abs(tktkmass-1.019455)<1.6205386316897691e-02";
      opt_cut4 = "chi2cl>3.8738149038918666e-02&&(d0/d0Err)>4.3757767373592902e+00&&cos(dtheta)>-7.8046623787916514e-01&&abs(trk2Dxy/trk2D0Err)>2.1125706915688469e-01&&abs(tktkmass-1.019455)<1.6205386316897691e-02";
      opt_cut5 = "chi2cl>3.8738149038918666e-02&&(d0/d0Err)>4.3757767373592902e+00&&cos(dtheta)>-7.8046623787916514e-01&&abs(trk1Dxy/trk1D0Err)>3.6438129126563079e-03&&abs(tktkmass-1.019455)<1.6205386316897691e-02";
      opt_cut6 = "chi2cl>3.8738149038918666e-02&&(d0/d0Err)>4.3757767373592902e+00&&cos(dtheta)>-7.8046623787916514e-01&&abs(trk1Dxy/trk1D0Err)>3.6438129126563079e-03&&abs(trk2Dxy/trk2D0Err)>2.1125706915688469e-01";
      wSignal = 56.0986;
      wBackground = 2497.44;
    }
   
  if(selection=="Bs_tktkmass")
    {
      ...
      basic_cut_gen="abs(y+0.465)<1.93&&(pt>10.)&&(isSignal==6)";
      opt_cut = "chi2cl>1.2754195057166534e-01&&(d0/d0Err)>3.0787144533607362e+00&&cos(dtheta)>8.0727116049250081e-01&&abs(trk1Dxy/trk1D0Err)>8.8565874731297090e-01&&abs(trk2Dxy/trk2D0Err)>7.8259613074689804e-01&&abs(tktkmass-1.019455)<1.7672336156224325e-02";
      opt_cut1 = "(d0/d0Err)>3.0787144533607362e+00&&cos(dtheta)>8.0727116049250081e-01&&abs(trk1Dxy/trk1D0Err)>8.8565874731297090e-01&&abs(trk2Dxy/trk2D0Err)>7.8259613074689804e-01&&abs(tktkmass-1.019455)<1.7672336156224325e-02";
      opt_cut2 = "chi2cl>1.2754195057166534e-01&&cos(dtheta)>8.0727116049250081e-01&&abs(trk1Dxy/trk1D0Err)>8.8565874731297090e-01&&abs(trk2Dxy/trk2D0Err)>7.8259613074689804e-01&&abs(tktkmass-1.019455)<1.7672336156224325e-02";
      opt_cut3 = "chi2cl>1.2754195057166534e-01&&(d0/d0Err)>3.0787144533607362e+00&&abs(trk1Dxy/trk1D0Err)>8.8565874731297090e-01&&abs(trk2Dxy/trk2D0Err)>7.8259613074689804e-01&&abs(tktkmass-1.019455)<1.7672336156224325e-02";
      opt_cut4 = "chi2cl>1.2754195057166534e-01&&(d0/d0Err)>3.0787144533607362e+00&&cos(dtheta)>8.0727116049250081e-01&&abs(trk2Dxy/trk2D0Err)>7.8259613074689804e-01&&abs(tktkmass-1.019455)<1.7672336156224325e-02";
      opt_cut5 = "chi2cl>1.2754195057166534e-01&&(d0/d0Err)>3.0787144533607362e+00&&cos(dtheta)>8.0727116049250081e-01&&abs(trk1Dxy/trk1D0Err)>8.8565874731297090e-01&&abs(tktkmass-1.019455)<1.7672336156224325e-02";
      opt_cut6 = "chi2cl>1.2754195057166534e-01&&(d0/d0Err)>3.0787144533607362e+00&&cos(dtheta)>8.0727116049250081e-01&&abs(trk1Dxy/trk1D0Err)>8.8565874731297090e-01&&abs(trk2Dxy/trk2D0Err)>7.8259613074689804e-01";
      wSignal = 61.9579;
      wBackground = 2389.07;
    }

  if(selection=="Bs_tktkmass_trkPt")
    {
      ...
      basic_cut_gen="abs(y+0.465)<1.93&&(pt>10.)&&(isSignal==6)";
      opt_cut = "chi2cl>5.3976370462985708e-02&&(d0/d0Err)>3.7081323617849611e+00&&cos(dtheta)>2.9318172079172966e-01&&abs(tktkmass-1.019455)<1.7275388425961970e-02";
      opt_cut1 = "(d0/d0Err)>3.7081323617849611e+00&&cos(dtheta)>2.9318172079172966e-01&&abs(tktkmass-1.019455)<1.7275388425961970e-02";
      opt_cut2 = "chi2cl>5.3976370462985708e-02&&cos(dtheta)>2.9318172079172966e-01&&abs(tktkmass-1.019455)<1.7275388425961970e-02";
      opt_cut3 = "chi2cl>5.3976370462985708e-02&&(d0/d0Err)>3.7081323617849611e+00&&abs(tktkmass-1.019455)<1.7275388425961970e-02";
      opt_cut6 = "chi2cl>5.3976370462985708e-02&&(d0/d0Err)>3.7081323617849611e+00&&cos(dtheta)>2.9318172079172966e-01";
  ...
  if(selection=="Bs_chi2_trkPt")
    {
      ...
      opt_cut1 = "(d0/d0Err)>3.3736922985841797e+00&&cos(dtheta)>2.5997067060605700e-01&&abs(tktkmass-1.019455)<1.5508735352954923e-02";
      opt_cut2 = "chi2cl>3.7135302389090241e-02&&cos(dtheta)>2.5997067060605700e-01&&abs(tktkmass-1.019455)<1.5508735352954923e-02";
      opt_cut3 = "chi2cl>3.7135302389090241e-02&&(d0/d0Err)>3.3736922985841797e+00&&abs(tktkmass-1.019455)<1.5508735352954923e-02";
      opt_cut6 = "chi2cl>3.7135302389090241e-02&&(d0/d0Err)>3.3736922985841797e+00&&cos(dtheta)>2.5997067060605700e-01";

      wSignal = 51.2328;
      wBackground = 716.288;
    }

  if(selection=="Bs_chi2")
    {
      ...
      basic_cut_gen="abs(y+0.465)<1.93&&(pt>10.)&&(isSignal==6)";
      opt_cut = "chi2cl>2.4179117361920875e-02&&(d0/d0Err)>3.0165682253740371e+00&&cos(dtheta)>-8.3521834882370838e-01&&abs(trk1Dxy/trk1D0Err)>9.7354008092318800e-01&&abs(trk2Dxy/trk2D0Err)>6.9003550420960158e-01&&abs(tktkmass-1.019455)<9.9701444695108350e-03";
      opt_cut1 = "(d0/d0Err)>3.0165682253740371e+00&&cos(dtheta)>-8.3521834882370838e-01&&abs(trk1Dxy/trk1D0Err)>9.7354008092318800e-01&&abs(trk2Dxy/trk2D0Err)>6.9003550420960158e-01&&abs(tktkmass-1.019455)<9.9701444695108350e-03";
      opt_cut2 = "chi2cl>2.4179117361920875e-02&&cos(dtheta)>-8.3521834882370838e-01&&abs(trk1Dxy/trk1D0Err)>9.7354008092318800e-01&&abs(trk2Dxy/trk2D0Err)>6.9003550420960158e-01&&abs(tktkmass-1.019455)<9.9701444695108350e-03";
      opt_cut3 = "chi2cl>2.4179117361920875e-02&&(d0/d0Err)>3.0165682253740371e+00&&abs(trk1Dxy/trk1D0Err)>9.7354008092318800e-01&&abs(trk2Dxy/trk2D0Err)>6.9003550420960158e-01&&abs(tktkmass-1.019455)<9.9701444695108350e-03";
      opt_cut4 = "chi2cl>2.4179117361920875e-02&&(d0/d0Err)>3.0165682253740371e+00&&cos(dtheta)>-8.3521834882370838e-01&&abs(trk2Dxy/trk2D0Err)>6.9003550420960158e-01&&abs(tktkmass-1.019455)<9.9701444695108350e-03";
      opt_cut5 = "chi2cl>2.4179117361920875e-02&&(d0/d0Err)>3.0165682253740371e+00&&cos(dtheta)>-8.3521834882370838e-01&&abs(trk1Dxy/trk1D0Err)>9.7354008092318800e-01&&abs(tktkmass-1.019455)<9.9701444695108350e-03";
      opt_cut6 = "chi2cl>2.4179117361920875e-02&&(d0/d0Err)>3.0165682253740371e+00&&cos(dtheta)>-8.3521834882370838e-01&&abs(trk1Dxy/trk1D0Err)>9.7354008092318800e-01&&abs(trk2Dxy/trk2D0Err)>6.9003550420960158e-01";
      wSignal = 57.6796;
      wBackground = 2424.84;
    }
  ...
  MIN=0;
  STEP=0.005;
  if(selection=="Bs_tktkmass") STEP=0.02;
  if(selection=="Bs_tktkmass_trkPt") STEP=0.01;
  for(i=0;i<10;i++)
    {
  ...
  MIN=-1;
  if(selection=="Bs_tktkmass") MIN=0;
  STEP=0.2;
  for(i=0;i<10;i++)
    {
      variable[i]=MIN+i*STEP;
  ...
  */
  ...
  for(i=0;i<10;i++)
    {
      ...
      sprintf(CUT,"%.3f",variable[i]);
      cout<<CUT<<"  ";
      background->Project("hmassBcut_tktkmass","mass",Form("%s&&%s&&abs(tktkmass-1.019455)<%s",basic_cut_data.Data(),opt_cut6.Data(),CUT));
      signal->Project("hmassScut_tktkmass","mass",Form("%s&&%s&&abs(tktkmass-1.019455)<%s",basic_cut_mc.Data(),opt_cut6.Data(),CUT));
  ...
  gsignalEff_tktkmass->GetXaxis()->SetTitle("abs(tktkmass-PHI_MASS) cut");
  ...
  gbackgroundEff_tktkmass->GetXaxis()->SetTitle("abs(tktkmass-PHI_MASS) cut");
  ...
  gsig_tktkmass->GetXaxis()->SetTitle("abs(tktkmass-PHI_MASS) cut");
