...
NVar 4
chi2cl                        chi2cl                        chi2cl                        chi2cl                                                          'F'    [0.0100062899292,0.99994301796]
(d0/d0Err)                    _d0_D_d0Err_                  (d0/d0Err)                    (d0/d0Err)                                                      'F'    [0.00151297601406,758.607849121]
cos(dtheta)                   cos_dtheta_                   cos(dtheta)                   cos(dtheta)                                                     'F'    [-0.999999821186,1]
abs(trk1Dxy/trk1D0Err)        abs_trk1Dxy_D_trk1D0Err_      abs(trk1Dxy/trk1D0Err)        abs(trk1Dxy/trk1D0Err)                                          'F'    [0.000480414862977,203.900238037]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmax[0] = 0.999943017959595;
      fVmin[1] = 0.00151297601405531;
      fVmax[1] = 758.607849121094;
      fVmin[2] = -0.999999821186066;
      fVmax[2] = 1;
      fVmin[3] = 0.000480414862977341;
