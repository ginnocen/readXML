...
NVar 4
chi2cl                        chi2cl                        chi2cl                        chi2cl                                                          'F'    [0.0100016053766,0.999984681606]
(d0/d0Err)                    _d0_D_d0Err_                  (d0/d0Err)                    (d0/d0Err)                                                      'F'    [0.00437748106197,491.905181885]
cos(dtheta)                   cos_dtheta_                   cos(dtheta)                   cos(dtheta)                                                     'F'    [-1,1]
abs(tktkmass-0.89594)         abs_tktkmass_M_0.89594_       abs(tktkmass-0.89594)         abs(tktkmass-0.89594)                                           'F'    [1.13430026261e-07,0.39998716116]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      const char* inputVars[] = { "chi2cl", "(d0/d0Err)", "cos(dtheta)", "abs(tktkmass-0.89594)" };
      ...
      fVmin[0] = 0.0100016053766012;
      fVmax[0] = 0.999984681606293;
      fVmin[1] = 0.00437748106196523;
      fVmax[1] = 491.905181884766;
      fVmin[2] = -1;
      fVmax[2] = 1;
      fVmin[3] = 1.1343002626063e-07;
      fVmax[3] = 0.399987161159515;
