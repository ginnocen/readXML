...
NVar 4
chi2cl                        chi2cl                        chi2cl                        chi2cl                                                          'F'    [0.0101013267413,0.999746322632]
(d0/d0Err)                    _d0_D_d0Err_                  (d0/d0Err)                    (d0/d0Err)                                                      'F'    [0.0237549096346,235.647094727]
cos(dtheta)                   cos_dtheta_                   cos(dtheta)                   cos(dtheta)                                                     'F'    [-0.999998807907,1]
abs(tktkmass-1.019455)        abs_tktkmass_M_1.019455_      abs(tktkmass-1.019455)        abs(tktkmass-1.019455)                                          'F'    [9.97619622467e-07,0.0998385697603]
NSpec 0
...
class ReadCutsGA : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      const char* inputVars[] = { "chi2cl", "(d0/d0Err)", "cos(dtheta)", "abs(tktkmass-1.019455)" };
      ...
      fVmin[0] = 0.0101013267412782;
      fVmax[0] = 0.999746322631836;
      fVmin[1] = 0.0237549096345901;
      fVmax[1] = 235.647094726562;
      fVmin[2] = -0.999998807907104;
      fVmax[2] = 1;
      fVmin[3] = 9.97619622467028e-07;
      fVmax[3] = 0.0998385697603226;
